...
class LemonadeTests : BaseTest() {
    ...
    fun `test_initial_state`() {
        testState(R.string.select_string, R.drawable.lemon_tree)
    }
    ...
    fun `test_picking_lemon_proceeds_to_squeeze_state`() {
        ...
        testState(R.string.squeeze_string, R.drawable.lemon_squeeze)
    }
    ...
    fun `test_squeezing_lemon_proceeds_to_drink_state`() {
        ...
        onView(withId(R.id.imageView)).perform(click())
        juiceLemon()
        testState(R.string.drink_string, R.drawable.lemon_drink)
    }
    ...
    fun `test_drinking_juice_proceeds_to_restart_state`() {
        ...
        onView(withId(R.id.imageView)).perform(click())
        // Click image to progress state
        testState(R.string.reset_string, R.drawable.lemon_restart)
    }
